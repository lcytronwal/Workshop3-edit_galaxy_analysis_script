...
## Usage
This code requires csv files from Portsmouth Group
### This code was originally authored by @ksanderso1 and further developed here
To run this script, type ``` python3 galaxies_analysis.py``` in the command line
